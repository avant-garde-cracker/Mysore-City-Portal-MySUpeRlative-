...
<div class="container">
			...
			<input name="event_type" value="<?php echo $_GET['et']; ?>"><br><br>
 ...
 <?php  
		if(isset($_GET['update'])){
			...
			$pc = $_GET['price'];
			$ety=$_GET['event_type'];
			$q = "update promote set event_name='$evn', date_from = '$dfm', date_to='$dtn', venue='$v', time='$t', price='$pc', event_type = '$ety' where id = '$id'";
